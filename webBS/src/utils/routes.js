...
export function convertRouter(asyncRoutes) {
  return asyncRoutes.map((route) => {
    if (route.component) {
      ...
      } else if(route.component === 'VabComLayout'){
        route.component = (resolve) => require(['@/vab/layouts/VabLayoutCommon'], resolve)
      }else if(route.component === 'VabRedLayout'){
        route.component = (resolve) => require(['@/vab/layouts/VabLayoutRedHorizontal'], resolve)
      }else if(route.component === 'VabComRedLayout'){
        route.component = (resolve) => require(['@/vab/layouts/VabLayoutRedCommon'], resolve)
      }else {

<template>
  <div class="guideage">
    <el-card class="box-card">
        ...
        <div class="text item">
          <el-button class="addbtn" type="primary" size="medium" @click="addguide">添加</el-button>
          <el-table v-loading="tabloading" :data="tableData" border tooltip-effect="dark" :element-loading-text="loadingText">
            ...
            <el-table-column label="操作" align="center" width="400px">
              <template v-slot="scope">
                <el-button type="warning" plain size="small" @click="lookClick(scope.row.pid)">查看</el-button>
    ...
    <conventlog ref="convent" :isphone="false" @getData="getListData" />
  </div>
</template>

<script>
export { default } from './js/guideage'
</script>
